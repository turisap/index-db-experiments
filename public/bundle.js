...
(function () {
	...
	*/
	...
	var IndexDBController = /** @class */ (function () {
	    ...
	    IndexDBController.prototype.connect = function (config) {
	    ...
	    IndexDBController.prototype.onConnectError = function (event) {
	        var _a, _b;
	        this.error = (_b = (_a = event.target) === null || _a === void 0 ? void 0 : _a.error) === null || _b === void 0 ? void 0 : _b.message;
	    ...
	    IndexDBController.prototype.onUpgradeNeeded = function (event) {
	        ...
	        if (this.db) {
	            ...
	            this.storesConfig.forEach(function (config) {
	                if (!_this.db.objectStoreNames.contains(config.name)) {
	                    _this.db.createObjectStore(config.name, config.params);
	                }
	            });
	            Array.from(this.db.objectStoreNames).forEach(function (name) {
	                if (!newStoresNames_1.includes(name)) {
	...
	ReactDOM.render(jsxRuntime.exports.jsx(React.StrictMode, { children: jsxRuntime.exports.jsx(App, {}, void 0) }, void 0), document.getElementById("root"));
